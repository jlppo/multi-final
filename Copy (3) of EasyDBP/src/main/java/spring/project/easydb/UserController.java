...
/*	//select--------------------------------------------------------------
	...
	//insert--------------------------------------------------------------
/*	@RequestMapping(value="/SQLTab", method=RequestMethod.GET)
	public String SQLTabInsert(){
		
		return "/user/SQLTab";
	}
	@RequestMapping(value="/SQLTab", method=RequestMethod.POST)
	@ResponseBody
	public String SQLInsert(String column){
		StringTokenizer st = new StringTokenizer(column, " ");
		String w=st.nextToken().toUpperCase();
		
		List<HashMap<String, String>> result=null;
		String result2="1 row created.";
		
		if(w.equals("INSERT")){
			result= userDao.insert(column);
	...
	//update--------------------------------------------------------------
	@RequestMapping(value="/SQLTab", method=RequestMethod.GET)
	public String SQLTabUpdate(){
		
		return "/user/SQLTab";
	}
	@RequestMapping(value="/SQLTab", method=RequestMethod.POST)
	@ResponseBody
	public String SQLUpdate(String column){
		StringTokenizer st = new StringTokenizer(column, " ");
		String w=st.nextToken().toUpperCase();
		
		List<HashMap<String, String>> result=null;
		String result2="1 row updated.";
	...
	//delete--------------------------------------------------------------
	@RequestMapping(value="/SQLTab", method=RequestMethod.GET)
	public String SQLTabDelete(){
		
		return "/user/SQLTab";
	}
	@RequestMapping(value="/SQLTab", method=RequestMethod.POST)
	@ResponseBody
	public String SQLDelete(String column){
		StringTokenizer st = new StringTokenizer(column, " ");
		String w=st.nextToken().toUpperCase();
		
		List<HashMap<String, String>> result=null;
		String result2="1 row deleted.";
